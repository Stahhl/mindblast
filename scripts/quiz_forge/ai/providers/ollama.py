...
class OllamaProvider:
    def rerank_distractors(self, payload: dict[str, object], settings: AISettings) -> AIRerankResponse:
        ...
        try:
            ...
            raise RuntimeError(f"Could not parse Ollama rerank response: {exc}") from exc
