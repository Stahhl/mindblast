...
2. Confirm the scheduled workflow runs and creates `quizzes/YYYY-MM-DD.json`.
3. Review the first generated quiz file and tune prompt wording or selection rules if needed.
